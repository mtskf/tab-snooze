...
/**
 * Dialog component to display tabs that failed to restore
 * @param {Object} props
 * @param {boolean} props.open - Whether the dialog is open
 * @param {function} props.onOpenChange - Callback when open state changes
 * @param {Array<{id: string, url: string, title: string, favicon?: string}>} props.failedTabs - Array of failed tabs
 */
export default function FailedTabsDialog({ open, onOpenChange, failedTabs }) {
